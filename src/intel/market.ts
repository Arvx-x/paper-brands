...
export async function buildCategoryPack(
  ...
  const base: Provenance =
    brief.provenance ??
    ({ grounded: false, confidence: "low", lensesPlanned: 0, lensesSucceeded: 0, missingLenses: [], distinctDomains: 0, independentDomains: 0, fetchedSources: 0, sourceClassCounts: {}, citationCountRaw: 0, attributionRate: 0, attributedItems: 0, totalItems: 0, independentItems: 0, skuCount: 0, providersUsed: [], truncated: false, degraded: !brief.evidence, userVoices: 0, userSkus: 0, overridesApplied: [], skuConflicts: 0 } satisfies Provenance);
